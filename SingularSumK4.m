function [ intsum ] = SingularSumK4(KER, T, j, nf)
%%SingularSumK4 Summation of the nl analytic integrals K3 derived from the
...
%--------------------------------------------------------------------------
% Output:
%   intsum - The summation of the analytic integrals K4 of the extracted
...
%--------------------------------------------------------------------------
  ...
  for l = 1 : KER.nl
    ...
    intsum = intsum + KER.dGFsingCoeff(n) ...
           .* T.getSingularTermK4(KER.rf(nf,:), n - 1, j);
  end
